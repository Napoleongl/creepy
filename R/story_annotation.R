...
load("data/episode_download.Rdata")

udsv <- udpipe_load_model("other/swedish-talbanken-ud-2.4-190531.udpipe")
...
save(episode_data, file="data/episode_data.RData")
stoppord <- utf8::as_utf8(unname(unlist(read.csv("other/stoppord-mycket.csv", 
...
save(ud_raw, file = "data/annotated_text.RData")
